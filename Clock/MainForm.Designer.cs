namespace Clock
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tsmiShowControls.CheckStateChanged += new System.EventHandler(this.tsmiShowControls_CheckStateChanged);
			// 
			// toolStripSeparator1
			// 
			...
			this.tsmiFont.CheckedChanged += new System.EventHandler(this.tsmiFont_CheckedChanged_1);
			// 
			// tsmiColor
			// 
			...
			this.checkBoxShowWeek.CheckedChanged += new System.EventHandler(this.checkBoxShowWeek_CheckedChanged);
			// 
			// buttonHideControls
			// 
